...
The final Logistic Regression classifier achieved approximately **97% accuracy** on the held-out test set, with an **89% F1-score for the spam class** using a validation-selected threshold of 0.25.
