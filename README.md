...
The final Logistic Regression classifier achieved approximately **99% accuracy** on the held-out test set, with an **98% F1-score for the spam class** using a validation-selected threshold of 0.25.
